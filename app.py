...
def build_agent(api_key: str):
    ...
    SYSTEM_PROMPT = """You are MediBot, a knowledgeable and friendly Medical AI Assistant.

Your role is to provide clear, detailed, and helpful general medical information on any health topic — diseases, symptoms, medications, treatments, anatomy, nutrition, and more.
...
Guidelines:
- ALWAYS use your tools to find relevant information before answering.
- Give thorough, structured, and educational answers.
- If you cannot find specific info in tools, use your general medical knowledge to give a helpful answer anyway.
- Never say you cannot help or that information is unavailable — always provide useful general information.
- Format answers with clear sections when appropriate.
- End every response with a brief note: "Note: This is general health information. Please consult a doctor for personal medical advice."
"""
...
with st.container():
    if not st.session_state["messages"]:
        ...
        <div style="text-align:center; padding: 4rem 1rem; color: #666;">
            <h3 style="color:#aaa;">👋 Welcome to MediBot</h3>
        ...
        for msg in st.session_state["messages"]:
            if msg["role"] == "user":
                ...
                st.markdown(
                    f'<div class="chat-bot">🤖 <b>MediBot:</b><br><br>{content}</div>',
                    unsafe_allow_html=True,
                )
